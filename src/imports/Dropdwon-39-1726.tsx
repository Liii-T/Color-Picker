import svgPaths from "./svg-m8grnke666";
...
export default function Dropdwon() {
  return (
    <div className="content-stretch flex flex-col items-end pt-[30px] relative shadow-[0px_1px_12px_0px_rgba(51,51,51,0.08)] size-full" data-name="dropdwon">
