import svgPaths from "./svg-dlw4uizpz6";
...
function Container() {
  return (
    <div className="content-stretch flex gap-[7px] h-full items-center justify-end pr-[12px] relative shrink-0 w-[70px]" data-name="Container">
      <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">
        <p className="leading-[normal]">快3</p>
      </div>
...
function PrimaryColor() {
  return (
    <div className="bg-[#317455] content-stretch flex items-center p-[2px] relative rounded-[99px] shrink-0 size-[32px]" data-name="Primary_Color">
      <Frame1 />
    </div>
  );
}
    ...
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Table color">
      ...
      <div className="relative rounded-[4.53px] shrink-0 w-[92px]" data-name="Input">
        <div className="content-stretch flex gap-[4px] items-center leading-[20px] not-italic overflow-clip px-[12px] py-[8px] relative rounded-[inherit] text-[14px] w-full">
          ...
          <p className="font-['PingFang_SC:Medium',sans-serif] min-w-[24px] relative shrink-0 text-white">317455</p>
        </div>
...
function SelectCursor() {
  return (
    <div className="absolute contents left-[147px] top-[66px]" data-name="select-cursor">
      <div className="absolute left-[147px] size-[14px] top-[66px]">
      ...
      <div className="absolute left-[147px] size-[14px] top-[66px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
          <circle cx="7" cy="7" fill="var(--fill-0, #317455)" id="Ellipse 5" r="7" />
        </svg>
      </div>
    </div>
  );
...
function HueSelectCursor() {
  return (
    <div className="absolute contents left-[147px] top-[66px]" data-name="hue-select-cursor">
      <SelectCursor />
    </div>
  );
}
  ...
  return (
    <div className="h-[160px] relative shrink-0 w-full" data-name="color-space">
      ...
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 160">
        <g id="color-space">
          <path d="M0 0H375V160H0V0Z" fill="var(--fill-0, #00FF89)" />
          <path d="M0 0H375V160H0V0Z" fill="url(#paint0_linear_48_866)" />
          <path d="M0 0H375V160H0V0Z" fill="url(#paint1_linear_48_866)" />
          <path d="M0 0H375V160H0V0Z" fill="var(--fill-3, black)" fillOpacity="0.2" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_48_866" x1="375" x2="0" y1="80" y2="80">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="1" stopColor="white" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_48_866" x1="187.5" x2="187.5" y1="160" y2="-1.51673e-06">
            <stop />
...
function Slider() {
  return (
    <div className="h-[16px] relative rounded-[4px] shrink-0 w-full" data-name="Slider" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 0, 0) 0%, rgb(255, 255, 0) 16.6%, rgb(0, 255, 0) 33.3%, rgb(0, 255, 255) 50%, rgb(0, 0, 255) 65%, rgb(158, 0, 255) 75%, rgb(255, 0, 167) 89.525%, rgb(255, 0, 0) 100%)" }}>
      <div className="-translate-y-1/2 absolute content-stretch flex h-[24px] items-center px-[4px] py-px right-[48px] top-1/2" data-name="_Control handle">
