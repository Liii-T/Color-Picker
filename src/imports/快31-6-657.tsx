import svgPaths from "./svg-5u5o543v2s";
...
function SuccessNoCircle() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="success_no_circle 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="success_no_circle 1">
          <path d={svgPaths.p2e462820} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame3() {
  return (
    <div className="bg-[#06bf04] content-stretch flex items-center justify-center p-[8px] relative rounded-[999px] shrink-0 size-[24px]">
      <SuccessNoCircle />
    </div>
  );
}
...
function Close() {
  return (
    <button className="absolute block cursor-pointer right-[10px] size-[18px] top-[10px]" data-name="close">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g>
          <path d={svgPaths.p667a880} fill="var(--fill-0, #7D7D7D)" id="Vector" />
        </g>
      </svg>
    </button>
  );
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="main">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center justify-center pb-[28px] pt-[36px] px-[20px] relative w-full">
          <Frame3 />
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black text-center whitespace-nowrap">
            <p className="leading-[normal]">保存成功</p>
          </div>
          <Close />
        </div>
      </div>
...
function Frame2() {
  return (
    <div className="bg-white flex-[1_0_0] h-[40px] min-h-px min-w-px relative">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[84px] relative size-full">
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#575858] text-[14px] text-center whitespace-nowrap">
            <p className="leading-[normal]">恢复默认</p>
          </div>
        </div>
      </div>
...
function Frame1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[40px] min-h-px min-w-px relative">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[84px] relative size-full">
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#dc3b40] text-[14px] text-center whitespace-nowrap">
            <p className="leading-[normal]">复制颜色</p>
          </div>
        </div>
      </div>
      <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_-0.5px_0px_0px_0px_#dfdfdf,inset_0px_0.5px_0px_0px_#e5e5e5]" />
...
function Alert() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white content-stretch flex flex-col items-start left-[calc(50%+0.5px)] overflow-clip rounded-[8px] top-1/2 w-[260px]" data-name="alert">
      <Main1 />
      <Btn />
    </div>
  );
...
function Component() {
  return (
    <div className="absolute h-[734px] left-0 top-0 w-[375px]" data-name="成功">
