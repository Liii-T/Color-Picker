import svgPaths from "./svg-hkzuk99s1c";
...
function Background1() {
  return (
    <div className="bg-[#256748] content-stretch flex flex-col h-full items-center justify-center px-[5px] py-[28px] relative shrink-0 w-[16px]" data-name="Background">
      <TriangleLeftSvg />
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex flex-col h-[68px] items-start relative shrink-0 w-full" data-name="Header">
...
function Main() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px py-[12px] relative w-full" data-name="Main">
      <Container4 />
      <List1 />
    </div>
  );
...
function BgPreview() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-center justify-between min-h-px min-w-px overflow-clip relative rounded-[8px] w-full" data-name="bg_preview">
      <Header />
      <Main />
    </div>
  );
        ...
        <div className="bg-[#1a1b1a] flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="Input">
          <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex font-['Inter:Medium',sans-serif] font-medium gap-[4px] items-center leading-[20px] not-italic px-[12px] py-[8px] relative text-[#969298] text-[14px] w-full">
              ...
              <p className="min-w-[24px] relative shrink-0">256748</p>
            </div>
          </div>
        </div>
      </div>
...
function TablerIconReload() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="tabler-icon-reload">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="tabler-icon-reload">
          <path d={svgPaths.pd697780} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function ReloadBtn() {
  return (
    <div className="bg-[#575858] content-stretch flex items-center p-[10px] relative rounded-[4px] shrink-0" data-name="Reload_btn">
      <TablerIconReload />
    </div>
  );
}
