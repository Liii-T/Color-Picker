import svgPaths from "./svg-a6ndmskxc5";
...
function TableColor() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Table color">
      <PrimaryColor />
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[92px]" data-name="Primary_Color Values">
        <div className="relative rounded-[4.53px] shrink-0" data-name="Input">
          <div className="content-stretch flex gap-[4px] items-center leading-[20px] not-italic overflow-clip px-[12px] py-[8px] relative rounded-[inherit] text-[14px]">
    ...
    <div className="h-[160px] relative shrink-0 w-full" data-name="color-space">
      ...
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 160">
        <g id="color-space">
          ...
          <path d="M0 0H375V160H0V0Z" fill="url(#paint0_linear_15_1582)" />
          <path d="M0 0H375V160H0V0Z" fill="url(#paint1_linear_15_1582)" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_15_1582" x1="375" x2="0" y1="80" y2="80">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="1" stopColor="white" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_15_1582" x1="187.5" x2="187.5" y1="160" y2="-1.51673e-06">
            <stop />
