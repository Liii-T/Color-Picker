import svgPaths from "./svg-0jrunlb52x";
...
function SelectCursor() {
  return (
    <div className="absolute contents left-[187px] top-[93px]" data-name="select-cursor">
      <div className="absolute left-[187px] size-[14px] top-[93px]">
      ...
      <div className="absolute left-[187px] size-[14px] top-[93px]">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
          <circle cx="7" cy="7" fill="var(--fill-0, #2C6349)" id="Ellipse 5" r="7" />
        </svg>
      </div>
    </div>
  );
...
function HueSelectCursor() {
  return (
    <div className="absolute contents left-[187px] top-[93px]" data-name="hue-select-cursor">
      <SelectCursor />
    </div>
  );
}
    ...
    <div className="h-[160px] relative shrink-0 w-full" data-name="color-space">
      ...
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 375 160">
        <g id="color-space">
          ...
          <path d="M0 0H375V160H0V0Z" fill="url(#paint0_linear_48_850)" />
          <path d="M0 0H375V160H0V0Z" fill="url(#paint1_linear_48_850)" />
          <path d="M0 0H375V160H0V0Z" fill="var(--fill-3, black)" fillOpacity="0.2" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_48_850" x1="375" x2="0" y1="80" y2="80">
            <stop stopColor="white" stopOpacity="0" />
            <stop offset="1" stopColor="white" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_48_850" x1="187.5" x2="187.5" y1="160" y2="-1.51673e-06">
            <stop />
